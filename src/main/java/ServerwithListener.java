...
public class ServerwithListener {
	...
	private static  JLabel imag_lab1	;
	private static  JLabel imag_lab2	;
	...
	public static void showUI(){
		//����̨����
	       JFrame jf = new JFrame("hellǫ");setListener(jf);
	       //����̨��С
	       jf.setSize(800, 400);
	       //imag_lab���ڴ�Ż���
	       imag_lab = new JLabel();
		imag_lab.setName("hellll");
		imag_lab1 = new JLabel();
		imag_lab2 = new JLabel();
	       jf.add(imag_lab);
		jf.add(imag_lab1);
		jf.add(imag_lab2);
